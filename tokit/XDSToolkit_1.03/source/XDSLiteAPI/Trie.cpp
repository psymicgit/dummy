...
public:
	...
	void *Insert(int keydiff, unsigned char *key, int keylen, void *data, int keyTest);
};
...
*/
void *trie_node::Insert(int keydiff, unsigned char *key, int keylen, void *data, int keyTest)
{
