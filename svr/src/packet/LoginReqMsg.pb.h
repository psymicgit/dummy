...
#ifndef PROTOBUF_LoginReqMsg_2eproto__INCLUDED
#define PROTOBUF_LoginReqMsg_2eproto__INCLUDED
...
class LoginReq : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_LoginReqMsg_2eproto();
  friend void protobuf_AssignDesc_LoginReqMsg_2eproto();
  friend void protobuf_ShutdownFile_LoginReqMsg_2eproto();
...
// required string pwd = 2;
inline bool LoginReq::has_pwd() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void LoginReq::set_has_pwd() {
  _has_bits_[0] |= 0x00000004u;
}
inline void LoginReq::clear_has_pwd() {
  _has_bits_[0] &= ~0x00000004u;
}
...
#endif  // PROTOBUF_LoginReqMsg_2eproto__INCLUDED
