...
extern "C" int lua_public_key_decrypt(lua_State* L)
{
    ...
    int decrypt_len = 0;
    char *decrypt_text = public_key_decrypt((char*)decoded_text, decode_len, public_key, &decrypt_len, &errmsg);
...
extern "C" __declspec(dllexport) int luaopen_rsa(lua_State* L)
{
