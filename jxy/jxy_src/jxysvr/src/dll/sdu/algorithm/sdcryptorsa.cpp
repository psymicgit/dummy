...
cleanup:
    ...
    INT32 RSASelfTest( INT32 verbose )
    {
        ...
        rsa.len = KEY_LEN;
        BNReadString( &rsa.N , 16, (char*)RSA_N  );
        BNReadString( &rsa.E , 16, (char*)RSA_E  );
        BNReadString( &rsa.D , 16, (char*)RSA_D  );
        BNReadString( &rsa.P , 16, (char*)RSA_P  );
        BNReadString( &rsa.Q , 16, (char*)RSA_Q  );
        BNReadString( &rsa.DP, 16, (char*)RSA_DP );
        BNReadString( &rsa.DQ, 16, (char*)RSA_DQ );
        BNReadString( &rsa.QP, 16, (char*)RSA_QP );
