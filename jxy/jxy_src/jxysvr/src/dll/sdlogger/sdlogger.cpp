...
void SDAPI CSDLogger::SetLogger(ISDLogger* pLogger)
{
    m_pLogger = pLogger;
}
...
void SDAPI CSDLogger::Critical(const WCHAR *format, ...)
{
...
void SDAPI CSDLogger::Info(const WCHAR *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
...
void SDAPI CSDLogger::Warn(const WCHAR *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
...
void SDAPI CSDLogger::Debug(const WCHAR *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
...
void SDAPI CSDLogger::Critical(const char *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
...
void SDAPI CSDLogger::Info(const char *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
...
void SDAPI CSDLogger::Warn(const char *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
...
void SDAPI CSDLogger::Debug(const char *format, ...)
{
	if (m_pLogger == NULL || format == NULL)
	{
		return;
