...
#define MAX_RETRIEVE_PASSWD_TOKEN_NUM 128
...
typedef struct tagDT_ZONE_PLAYER_DATA{
	UINT32           dwPlayerID; //加解密密钥 
	UINT8            byPlayerCareer; //加解密密钥 
	UINT16           wPlayerLevel; //加解密密钥 
	TCHAR            aszPlayerDspName[USERNAME_LEN]; //加解密密钥 
}DT_ZONE_PLAYER_DATA;
...
typedef struct tagPKT_CLIZS_REGISTER_REQ{
	tagPKT_CLIZS_REGISTER_REQ() { memset(this, 0, sizeof(tagPKT_CLIZS_REGISTER_REQ)); }
	TCHAR            aszDeviceID[DEVICEID_LEN]; //设备ID
	TCHAR            aszUserName[USERNAME_LEN]; //用户名
	TCHAR            aszUserPwd[USERPWD_LEN]; //密码
}PKT_CLIZS_REGISTER_REQ;

typedef struct tagPKT_CLIZS_REGISTER_ACK{
	tagPKT_CLIZS_REGISTER_ACK() { memset(this, 0, sizeof(tagPKT_CLIZS_REGISTER_ACK)); }
	UINT16           wErrCode; //加解密密钥 
}PKT_CLIZS_REGISTER_ACK;
...
typedef struct tagPKT_CLIZS_UN_BIND_REQ{
	tagPKT_CLIZS_UN_BIND_REQ() { memset(this, 0, sizeof(tagPKT_CLIZS_UN_BIND_REQ)); }
	UINT8            byAuthType; //认证类型
	TCHAR            aszDeviceID[DEVICEID_LEN]; //设备ID
	TCHAR            aszUserName[USERNAME_LEN]; //用户名 
}PKT_CLIZS_UN_BIND_REQ;

typedef struct tagPKT_CLIZS_UN_BIND_ACK{
	tagPKT_CLIZS_UN_BIND_ACK() { memset(this, 0, sizeof(tagPKT_CLIZS_UN_BIND_ACK)); }
	UINT16           wErrCode; //错误码
}PKT_CLIZS_UN_BIND_ACK;
...
typedef struct tagPKT_CLIZS_RETRIEVE_PASSWD_MOBILE_REQ{
	tagPKT_CLIZS_RETRIEVE_PASSWD_MOBILE_REQ() { memset(this, 0, sizeof(tagPKT_CLIZS_RETRIEVE_PASSWD_MOBILE_REQ)); }
	UINT8            abyMObile[MAX_MOBILE_LENGTH]; //用户手机号 
}PKT_CLIZS_RETRIEVE_PASSWD_MOBILE_REQ;

typedef struct tagPKT_CLIZS_RETRIEVE_PASSWD_MOBILE_ACK{
	tagPKT_CLIZS_RETRIEVE_PASSWD_MOBILE_ACK() { memset(this, 0, sizeof(tagPKT_CLIZS_RETRIEVE_PASSWD_MOBILE_ACK)); }
	UINT16           wErrCode; //错误码
	UINT8            abyToken[MAX_RETRIEVE_PASSWD_TOKEN_NUM]; //随机码
}PKT_CLIZS_RETRIEVE_PASSWD_MOBILE_ACK;

typedef struct tagPKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_REQ{
	tagPKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_REQ() { memset(this, 0, sizeof(tagPKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_REQ)); }
	UINT8            abyToken[MAX_RETRIEVE_PASSWD_TOKEN_NUM]; //随机码
	UINT8            abyVerCode[MAX_MOBILE_LENGTH]; //验证码 
}PKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_REQ;

typedef struct tagPKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_ACK{
	tagPKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_ACK() { memset(this, 0, sizeof(tagPKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_ACK)); }
	UINT8            abyVerCode[MAX_MOBILE_LENGTH]; //验证码 
	UINT16           wCountdown; //倒计时 
}PKT_CLIZS_RETRIEVE_PASSWD_VER_CODE_ACK;

typedef struct tagPKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_REQ{
	tagPKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_REQ() { memset(this, 0, sizeof(tagPKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_REQ)); }
	UINT8            abyToken[MAX_RETRIEVE_PASSWD_TOKEN_NUM]; //随机码
	UINT8            byPwdLen; //密码长度
	UINT8            abyNewPassWd[USERNAME_LEN]; //密码
}PKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_REQ;

typedef struct tagPKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_ACK{
	tagPKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_ACK() { memset(this, 0, sizeof(tagPKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_ACK)); }
	UINT16           wErrCode; //错误码
}PKT_CLIZS_RETRIEVE_PASSWD_NEWPASSWD_ACK;
...
enum EN_ProtoCliZS_MessageID
{
	...
	CLIZS_REGISTER_REQ              = 1012        ,
	CLIZS_REGISTER_ACK              = 1013        ,
	...
	CLIZS_UN_BIND_REQ               = 1018        ,
	CLIZS_UN_BIND_ACK               = 1019        ,
	...
	CLIZS_RETRIEVE_PASSWD_MOBILE_REQ  = 1024        ,
	CLIZS_RETRIEVE_PASSWD_MOBILE_ACK  = 1025        ,
	CLIZS_RETRIEVE_PASSWD_VER_CODE_REQ  = 1026        ,
	CLIZS_RETRIEVE_PASSWD_VER_CODE_ACK  = 1027        ,
	CLIZS_RETRIEVE_PASSWD_NEWPASSWD_REQ  = 1028        ,
	CLIZS_RETRIEVE_PASSWD_NEWPASSWD_ACK  = 1029        ,
};
