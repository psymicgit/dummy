...
BOOL CProtoCliZS::Init()
{
	...
	m_EncodeFuncArray[CLIZS_REGISTER_USERNAME_REQ - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_REGISTER_USERNAME_REQ;
	m_DecodeFuncArray[CLIZS_REGISTER_USERNAME_REQ - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_REGISTER_USERNAME_REQ;
	m_vecMsgList.push_back(CLIZS_REGISTER_USERNAME_REQ);
	if( (INT32)sizeof(PKT_CLIZS_REGISTER_USERNAME_REQ) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_REGISTER_USERNAME_REQ);

	m_EncodeFuncArray[CLIZS_REGISTER_USERNAME_ACK - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_REGISTER_USERNAME_ACK;
	m_DecodeFuncArray[CLIZS_REGISTER_USERNAME_ACK - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_REGISTER_USERNAME_ACK;
	m_vecMsgList.push_back(CLIZS_REGISTER_USERNAME_ACK);
	if( (INT32)sizeof(PKT_CLIZS_REGISTER_USERNAME_ACK) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_REGISTER_USERNAME_ACK);
	...
	m_EncodeFuncArray[CLIZS_UN_BIND_DEVICE_REQ - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_UN_BIND_DEVICE_REQ;
	m_DecodeFuncArray[CLIZS_UN_BIND_DEVICE_REQ - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_UN_BIND_DEVICE_REQ;
	m_vecMsgList.push_back(CLIZS_UN_BIND_DEVICE_REQ);
	if( (INT32)sizeof(PKT_CLIZS_UN_BIND_DEVICE_REQ) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_UN_BIND_DEVICE_REQ);

	m_EncodeFuncArray[CLIZS_UN_BIND_DEVICE_ACK - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_UN_BIND_DEVICE_ACK;
	m_DecodeFuncArray[CLIZS_UN_BIND_DEVICE_ACK - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_UN_BIND_DEVICE_ACK;
	m_vecMsgList.push_back(CLIZS_UN_BIND_DEVICE_ACK);
	if( (INT32)sizeof(PKT_CLIZS_UN_BIND_DEVICE_ACK) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_UN_BIND_DEVICE_ACK);
	...
	m_EncodeFuncArray[CLIZS_RESET_PASSWD_MOBILE_REQ - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_RESET_PASSWD_MOBILE_REQ;
	m_DecodeFuncArray[CLIZS_RESET_PASSWD_MOBILE_REQ - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_RESET_PASSWD_MOBILE_REQ;
	m_vecMsgList.push_back(CLIZS_RESET_PASSWD_MOBILE_REQ);
	if( (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_MOBILE_REQ) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_MOBILE_REQ);

	m_EncodeFuncArray[CLIZS_RESET_PASSWD_MOBILE_ACK - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_RESET_PASSWD_MOBILE_ACK;
	m_DecodeFuncArray[CLIZS_RESET_PASSWD_MOBILE_ACK - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_RESET_PASSWD_MOBILE_ACK;
	m_vecMsgList.push_back(CLIZS_RESET_PASSWD_MOBILE_ACK);
	if( (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_MOBILE_ACK) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_MOBILE_ACK);

	m_EncodeFuncArray[CLIZS_RESET_PASSWD_VER_CODE_REQ - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_RESET_PASSWD_VER_CODE_REQ;
	m_DecodeFuncArray[CLIZS_RESET_PASSWD_VER_CODE_REQ - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_RESET_PASSWD_VER_CODE_REQ;
	m_vecMsgList.push_back(CLIZS_RESET_PASSWD_VER_CODE_REQ);
	if( (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_VER_CODE_REQ) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_VER_CODE_REQ);

	m_EncodeFuncArray[CLIZS_RESET_PASSWD_VER_CODE_ACK - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_RESET_PASSWD_VER_CODE_ACK;
	m_DecodeFuncArray[CLIZS_RESET_PASSWD_VER_CODE_ACK - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_RESET_PASSWD_VER_CODE_ACK;
	m_vecMsgList.push_back(CLIZS_RESET_PASSWD_VER_CODE_ACK);
	if( (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_VER_CODE_ACK) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_VER_CODE_ACK);

	m_EncodeFuncArray[CLIZS_RESET_PASSWD_NEWPASSWD_REQ - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ;
	m_DecodeFuncArray[CLIZS_RESET_PASSWD_NEWPASSWD_REQ - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ;
	m_vecMsgList.push_back(CLIZS_RESET_PASSWD_NEWPASSWD_REQ);
	if( (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ);

	m_EncodeFuncArray[CLIZS_RESET_PASSWD_NEWPASSWD_ACK - PROTOCLIZS_MSGID_OFFSET] = &EncodePKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK;
	m_DecodeFuncArray[CLIZS_RESET_PASSWD_NEWPASSWD_ACK - PROTOCLIZS_MSGID_OFFSET] = &DecodePKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK;
	m_vecMsgList.push_back(CLIZS_RESET_PASSWD_NEWPASSWD_ACK);
	if( (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK) > m_iMaxPkgSize)
		m_iMaxPkgSize = (INT32)sizeof(PKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK);
...
{
	PKT_CLIZS_REGISTER_USERNAME_REQ *pstIn = (PKT_CLIZS_REGISTER_USERNAME_REQ*)pHost;
...
{
	PKT_CLIZS_REGISTER_USERNAME_REQ *pstOut = (PKT_CLIZS_REGISTER_USERNAME_REQ*)pHost;
...
{
	PKT_CLIZS_REGISTER_USERNAME_ACK *pstIn = (PKT_CLIZS_REGISTER_USERNAME_ACK*)pHost;
...
{
	PKT_CLIZS_REGISTER_USERNAME_ACK *pstOut = (PKT_CLIZS_REGISTER_USERNAME_ACK*)pHost;
...
{
	PKT_CLIZS_UN_BIND_DEVICE_REQ *pstIn = (PKT_CLIZS_UN_BIND_DEVICE_REQ*)pHost;
...
{
	PKT_CLIZS_UN_BIND_DEVICE_REQ *pstOut = (PKT_CLIZS_UN_BIND_DEVICE_REQ*)pHost;
...
{
	PKT_CLIZS_UN_BIND_DEVICE_ACK *pstIn = (PKT_CLIZS_UN_BIND_DEVICE_ACK*)pHost;
...
{
	PKT_CLIZS_UN_BIND_DEVICE_ACK *pstOut = (PKT_CLIZS_UN_BIND_DEVICE_ACK*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_MOBILE_REQ *pstIn = (PKT_CLIZS_RESET_PASSWD_MOBILE_REQ*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_MOBILE_REQ *pstOut = (PKT_CLIZS_RESET_PASSWD_MOBILE_REQ*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_MOBILE_ACK *pstIn = (PKT_CLIZS_RESET_PASSWD_MOBILE_ACK*)pHost;

	if(-1 == poNetData->AddWord(pstIn->wErrCode))
		return -1;

	INT32 i;
	for(i = 0; i < MAX_RESET_PASSWD_TOKEN_NUM; i++)
	{
...
{
	PKT_CLIZS_RESET_PASSWD_MOBILE_ACK *pstOut = (PKT_CLIZS_RESET_PASSWD_MOBILE_ACK*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_VER_CODE_REQ *pstIn = (PKT_CLIZS_RESET_PASSWD_VER_CODE_REQ*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_VER_CODE_REQ *pstOut = (PKT_CLIZS_RESET_PASSWD_VER_CODE_REQ*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_VER_CODE_ACK *pstIn = (PKT_CLIZS_RESET_PASSWD_VER_CODE_ACK*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_VER_CODE_ACK *pstOut = (PKT_CLIZS_RESET_PASSWD_VER_CODE_ACK*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ *pstIn = (PKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ *pstOut = (PKT_CLIZS_RESET_PASSWD_NEWPASSWD_REQ*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK *pstIn = (PKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK*)pHost;
...
{
	PKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK *pstOut = (PKT_CLIZS_RESET_PASSWD_NEWPASSWD_ACK*)pHost;
