...
BOOL CProtoCliLS::Init()
{
	...
	m_EncodeFuncArray[CLILS_BIND_CHECK_VER_CODE_REQ - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_BIND_CHECK_VER_CODE_REQ;
	m_DecodeFuncArray[CLILS_BIND_CHECK_VER_CODE_REQ - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_BIND_CHECK_VER_CODE_REQ;
	...
	m_EncodeFuncArray[CLILS_BIND_CHECK_VER_CODE_ACK - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_BIND_CHECK_VER_CODE_ACK;
	m_DecodeFuncArray[CLILS_BIND_CHECK_VER_CODE_ACK - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_BIND_CHECK_VER_CODE_ACK;
	...
	m_EncodeFuncArray[CLILS_UNBIND_MOBILE_REQ - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_UNBIND_MOBILE_REQ;
	m_DecodeFuncArray[CLILS_UNBIND_MOBILE_REQ - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_UNBIND_MOBILE_REQ;
	...
	m_EncodeFuncArray[CLILS_UNBIND_MOBILE_ACK - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_UNBIND_MOBILE_ACK;
	m_DecodeFuncArray[CLILS_UNBIND_MOBILE_ACK - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_UNBIND_MOBILE_ACK;
	...
	m_EncodeFuncArray[CLILS_UNBIND_CHECK_VER_CODE_REQ - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_UNBIND_CHECK_VER_CODE_REQ;
	m_DecodeFuncArray[CLILS_UNBIND_CHECK_VER_CODE_REQ - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_UNBIND_CHECK_VER_CODE_REQ;
	...
	m_EncodeFuncArray[CLILS_UNBIND_CHECK_VER_CODE_ACK - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_UNBIND_CHECK_VER_CODE_ACK;
	m_DecodeFuncArray[CLILS_UNBIND_CHECK_VER_CODE_ACK - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_UNBIND_CHECK_VER_CODE_ACK;
	...
	m_EncodeFuncArray[CLILS_GET_USER_EXPAND_REQ - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_GET_USER_EXPAND_REQ;
	m_DecodeFuncArray[CLILS_GET_USER_EXPAND_REQ - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_GET_USER_EXPAND_REQ;
	...
	m_EncodeFuncArray[CLILS_GET_USER_EXPAND_ACK - PROTOCLILS_MSGID_OFFSET] = &EncodePKT_CLILS_GET_USER_EXPAND_ACK;
	m_DecodeFuncArray[CLILS_GET_USER_EXPAND_ACK - PROTOCLILS_MSGID_OFFSET] = &DecodePKT_CLILS_GET_USER_EXPAND_ACK;
...
INT32 EncodePKT_CLILS_LOGIN_EX_REQ(void *pHost, CNetData* poNetData)
{
	...
	if(-1 == poNetData->AddTString(pstIn->aszAuthKey, sizeof(pstIn->aszAuthKey)))
		return -1;
...
INT32 DecodePKT_CLILS_LOGIN_EX_REQ(void *pHost, CNetData* poNetData)
{
	...
	if(-1 == poNetData->DelTString(pstOut->aszAuthKey, sizeof(pstOut->aszAuthKey)))
		return -1;
...
{
	PKT_CLILS_BIND_CHECK_VER_CODE_REQ *pstIn = (PKT_CLILS_BIND_CHECK_VER_CODE_REQ*)pHost;
...
{
	PKT_CLILS_BIND_CHECK_VER_CODE_REQ *pstOut = (PKT_CLILS_BIND_CHECK_VER_CODE_REQ*)pHost;
...
{
	PKT_CLILS_BIND_CHECK_VER_CODE_ACK *pstIn = (PKT_CLILS_BIND_CHECK_VER_CODE_ACK*)pHost;
...
{
	PKT_CLILS_BIND_CHECK_VER_CODE_ACK *pstOut = (PKT_CLILS_BIND_CHECK_VER_CODE_ACK*)pHost;
...
{
	PKT_CLILS_UNBIND_MOBILE_REQ *pstIn = (PKT_CLILS_UNBIND_MOBILE_REQ*)pHost;
...
{
	PKT_CLILS_UNBIND_MOBILE_REQ *pstOut = (PKT_CLILS_UNBIND_MOBILE_REQ*)pHost;
...
{
	PKT_CLILS_UNBIND_MOBILE_ACK *pstIn = (PKT_CLILS_UNBIND_MOBILE_ACK*)pHost;
...
{
	PKT_CLILS_UNBIND_MOBILE_ACK *pstOut = (PKT_CLILS_UNBIND_MOBILE_ACK*)pHost;
...
{
	PKT_CLILS_UNBIND_CHECK_VER_CODE_REQ *pstIn = (PKT_CLILS_UNBIND_CHECK_VER_CODE_REQ*)pHost;
...
{
	PKT_CLILS_UNBIND_CHECK_VER_CODE_REQ *pstOut = (PKT_CLILS_UNBIND_CHECK_VER_CODE_REQ*)pHost;
...
{
	PKT_CLILS_UNBIND_CHECK_VER_CODE_ACK *pstIn = (PKT_CLILS_UNBIND_CHECK_VER_CODE_ACK*)pHost;
...
{
	PKT_CLILS_UNBIND_CHECK_VER_CODE_ACK *pstOut = (PKT_CLILS_UNBIND_CHECK_VER_CODE_ACK*)pHost;
...
{
	DT_EXPAND_FUNC_PARAM *pstIn = (DT_EXPAND_FUNC_PARAM*)pHost;

	if(-1 == poNetData->AddByte(pstIn->byExpandType))
		return -1;

	if(-1 == poNetData->AddByte(pstIn->byExpandLen))
		return -1;

	INT32 i;
	for(i = 0; i < MAX_EXPAND_DATA_LEN; i++)
	{
		if(i >= (INT32)pstIn->byExpandLen)
			break;
		if(-1 == poNetData->AddByte(pstIn->abyExpandData[i]))
			return -1;
	}
...
{
	DT_EXPAND_FUNC_PARAM *pstOut = (DT_EXPAND_FUNC_PARAM*)pHost;

	if(-1 == poNetData->DelByte(pstOut->byExpandType))
		return -1;

	if(-1 == poNetData->DelByte(pstOut->byExpandLen))
		return -1;

	INT32 i;
	for(i = 0; i < MAX_EXPAND_DATA_LEN; i++)
	{
		if(i >= (INT32)pstOut->byExpandLen)
			break;
		if(-1 == poNetData->DelByte(pstOut->abyExpandData[i]))
			return -1;
	}
...
{
	DT_EXPAND_FUNC_PARAM_LST *pstIn = (DT_EXPAND_FUNC_PARAM_LST*)pHost;

	if(-1 == poNetData->AddByte(pstIn->byExpandNum))
		return -1;

	INT32 i;
	for(i = 0; i < MAX_EXPAND_FUN_NUM; i++)
	{
		if(i >= (INT32)pstIn->byExpandNum)
			break;
		if(-1 == EncodeDT_EXPAND_FUNC_PARAM(&pstIn->astExpandFuncParaInfo[i], poNetData))
			return -1;
	}
...
{
	DT_EXPAND_FUNC_PARAM_LST *pstOut = (DT_EXPAND_FUNC_PARAM_LST*)pHost;

	if(-1 == poNetData->DelByte(pstOut->byExpandNum))
		return -1;

	INT32 i;
	for(i = 0; i < MAX_EXPAND_FUN_NUM; i++)
	{
		if(i >= (INT32)pstOut->byExpandNum)
			break;
		if(-1 == DecodeDT_EXPAND_FUNC_PARAM(&pstOut->astExpandFuncParaInfo[i], poNetData))
			return -1;
	}
...
{
	PKT_CLILS_GET_USER_EXPAND_REQ *pstIn = (PKT_CLILS_GET_USER_EXPAND_REQ*)pHost;
...
{
	PKT_CLILS_GET_USER_EXPAND_REQ *pstOut = (PKT_CLILS_GET_USER_EXPAND_REQ*)pHost;
...
{
	PKT_CLILS_GET_USER_EXPAND_ACK *pstIn = (PKT_CLILS_GET_USER_EXPAND_ACK*)pHost;

	if(-1 == poNetData->AddWord(pstIn->wErrCode))
		return -1;

	if(-1 == EncodeDT_EXPAND_FUNC_PARAM_LST(&pstIn->stExpandFuncParaLst, poNetData))
		return -1;
...
{
	PKT_CLILS_GET_USER_EXPAND_ACK *pstOut = (PKT_CLILS_GET_USER_EXPAND_ACK*)pHost;

	if(-1 == poNetData->DelWord(pstOut->wErrCode))
		return -1;

	if(-1 == DecodeDT_EXPAND_FUNC_PARAM_LST(&pstOut->stExpandFuncParaLst, poNetData))
		return -1;
