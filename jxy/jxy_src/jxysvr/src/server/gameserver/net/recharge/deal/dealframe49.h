// DealFrame49.h: interface for the CDealFrame49 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME49_H_
#define _DEALFRAME49_H_
...
class CDealFrame49 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame49();
	virtual ~CDealFrame49();
	CDealFrame49(InterfaceDealBase::CGmManager * IN_pManager)
	{
