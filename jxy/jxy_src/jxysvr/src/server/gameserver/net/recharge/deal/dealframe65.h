// DealFrame65.h: interface for the CDealFrame65 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME65_H_
#define _DEALFRAME65_H_
...
class CDealFrame65 : public InterfaceDealBase::CGmDealFrame  
{
public:
    CDealFrame65();
    virtual ~CDealFrame65();
    CDealFrame65(InterfaceDealBase::CGmManager * IN_pManager)
    {
