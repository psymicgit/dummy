// DealFrame52.h: interface for the CDealFrame52 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME52_H_
#define _DEALFRAME52_H_
...
class CDealFrame52 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame52();
	virtual ~CDealFrame52();
	CDealFrame52(InterfaceDealBase::CGmManager * IN_pManager)
	{
