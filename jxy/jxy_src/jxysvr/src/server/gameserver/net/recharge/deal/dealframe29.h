// DealFrame29.h: interface for the CDealFrame29 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME29_H_
#define _DEALFRAME29_H_
...
class CDealFrame29 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame29();
	virtual ~CDealFrame29();
	CDealFrame29(InterfaceDealBase::CGmManager * IN_pManager)
	{
