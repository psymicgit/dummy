...
#ifndef _DEALFRAME59_H_
#define _DEALFRAME59_H_
...
class CDealFrame59 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame59();
	virtual ~CDealFrame59();
	CDealFrame59(InterfaceDealBase::CGmManager * IN_pManager)
	{
