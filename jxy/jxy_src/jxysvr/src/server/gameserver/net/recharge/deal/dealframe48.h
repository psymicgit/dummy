// DealFrame48.h: interface for the CDealFrame48 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME48_H_
#define _DEALFRAME48_H_

#include "rsdeal/rsdealframe.h"
#include <vector>
#include <map>
#include <string.h>
...
class CDealFrame48 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame48();
	virtual ~CDealFrame48();
	CDealFrame48(InterfaceDealBase::CGmManager * IN_pManager)
	{
...
private:
	void Register();
	BOOL CkResInvalid(map< string, vector<string> >& mapRes, string& strFirstInvalid);

private:
	InterfaceDealBase::CRsManager m_oManager;
};

#endif // !defined(_DEALFRAME48_H_)
