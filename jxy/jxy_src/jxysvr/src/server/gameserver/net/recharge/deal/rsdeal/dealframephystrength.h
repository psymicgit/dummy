...
#ifndef _DEALFRAMEPHYSTRENGTH_H_
#define _DEALFRAMEPHYSTRENGTH_H_



#include "rsdealframe.h"

class CDealFramePhystrength : public InterfaceDealBase::CRsDealFrame  
{
public:
	CDealFramePhystrength();
	virtual ~CDealFramePhystrength();
	CDealFramePhystrength(InterfaceDealBase::CRsManager * IN_pManager)
	{
