// DealFrame59.h: interface for the CDealFrame59 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME61_H_
#define _DEALFRAME61_H_
...
class CDealFrame61 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame61();
	virtual ~CDealFrame61();
	CDealFrame61(InterfaceDealBase::CGmManager * IN_pManager)
	{
