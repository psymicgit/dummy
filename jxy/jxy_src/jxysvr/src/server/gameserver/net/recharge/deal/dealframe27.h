// DealFrame27.h: interface for the CDealFrame27 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME27_H_
#define _DEALFRAME27_H_
...
class CDealFrame27 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame27();
	virtual ~CDealFrame27();
	CDealFrame27(InterfaceDealBase::CGmManager * IN_pManager)
	{
