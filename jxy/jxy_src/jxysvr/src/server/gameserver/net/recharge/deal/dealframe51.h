// DealFrame51.h: interface for the CDealFrame51 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME51_H_
#define _DEALFRAME51_H_
...
class CDealFrame51 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame51();
	virtual ~CDealFrame51();
	CDealFrame51(InterfaceDealBase::CGmManager * IN_pManager)
	{
