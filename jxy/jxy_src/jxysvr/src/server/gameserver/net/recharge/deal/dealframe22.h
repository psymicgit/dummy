// DealFrame22.h: interface for the CDealFrame22 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME22_H_
#define _DEALFRAME22_H_
...
class CDealFrame22 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame22();
	virtual ~CDealFrame22();
	CDealFrame22(InterfaceDealBase::CGmManager * IN_pManager)
	{
