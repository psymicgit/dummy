...
#ifndef _DEALFRAMESTUDYNOATTR_H_
#define _DEALFRAMESTUDYNOATTR_H_



#include "rsdealframe.h"

class CDealFrameStudyNoAttr : public InterfaceDealBase::CRsDealFrame
{
public:
    CDealFrameStudyNoAttr();
    virtual ~CDealFrameStudyNoAttr();
    CDealFrameStudyNoAttr(InterfaceDealBase::CRsManager * IN_pManager)
    {
