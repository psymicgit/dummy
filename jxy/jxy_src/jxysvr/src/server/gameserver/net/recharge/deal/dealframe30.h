// DealFrame30.h: interface for the CDealFrame30 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME30_H_
#define _DEALFRAME30_H_
...
class CDealFrame30 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame30();
	virtual ~CDealFrame30();
	CDealFrame30(InterfaceDealBase::CGmManager * IN_pManager)
	{
