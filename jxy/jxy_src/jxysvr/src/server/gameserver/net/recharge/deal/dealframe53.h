// DealFrame53.h: interface for the CDealFrame53 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME53_H_
#define _DEALFRAME53_H_
...
class CDealFrame53 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame53();
	virtual ~CDealFrame53();
	CDealFrame53(InterfaceDealBase::CGmManager * IN_pManager)
	{
