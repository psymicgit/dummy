// DealFrame14.h: interface for the CDealFrame14 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME14_H_
#define _DEALFRAME14_H_
...
class CDealFrame14 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame14();
	virtual ~CDealFrame14();
	CDealFrame14(InterfaceDealBase::CGmManager * IN_pManager)
	{
