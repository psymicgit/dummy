// DealFrame11.h: interface for the CDealFrame11 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME11_H_
#define _DEALFRAME11_H_
...
class CDealFrame11 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame11();
	virtual ~CDealFrame11();
	CDealFrame11(InterfaceDealBase::CGmManager * IN_pManager)
	{
