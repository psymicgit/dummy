// DealFrame16.h: interface for the CDealFrame16 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME16_H_
#define _DEALFRAME16_H_
...
class CDealFrame16 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame16();
	virtual ~CDealFrame16();
	CDealFrame16(InterfaceDealBase::CGmManager * IN_pManager)
	{
