...
#ifndef _DEALFRAMESTUDYCLI_H_
#define _DEALFRAMESTUDYCLI_H_



#include "rsdealframe.h"

class CDealFrameStudyCli : public InterfaceDealBase::CRsDealFrame  
{
public:
	CDealFrameStudyCli();
	virtual ~CDealFrameStudyCli();
	CDealFrameStudyCli(InterfaceDealBase::CRsManager * IN_pManager)
	{
