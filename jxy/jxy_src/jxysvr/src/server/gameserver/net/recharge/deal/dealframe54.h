// DealFrame54.h: interface for the CDealFrame54 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME54_H_
#define _DEALFRAME54_H_
...
class CDealFrame54 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame54();
	virtual ~CDealFrame54();
	CDealFrame54(InterfaceDealBase::CGmManager * IN_pManager)
	{
