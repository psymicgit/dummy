// DealFrame43.h: interface for the CDealFrame43 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME43_H_
#define _DEALFRAME43_H_
...
class CDealFrame43 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame43();
	virtual ~CDealFrame43();
	CDealFrame43(InterfaceDealBase::CGmManager * IN_pManager)
	{
