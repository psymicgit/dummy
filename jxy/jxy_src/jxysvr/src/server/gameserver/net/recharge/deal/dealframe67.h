...
#ifndef _DEALFRAME67_H_
#define _DEALFRAME67_H_
...
class CDealFrame67 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame67();
	virtual ~CDealFrame67();
	CDealFrame67(InterfaceDealBase::CGmManager * IN_pManager)
	{
