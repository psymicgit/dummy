// DealFrame33.cpp: implementation of the CDealFrame33 class.
//
//////////////////////////////////////////////////////////////////////


#include "dealframe33.h"
...
void CDealFrame33::Release()
{

}

UINT16 CDealFrame33::GetFrameType()
{
    return 33;
}

void CDealFrame33::Deal(CRCClient* poClinet, UINT32 dwSerialNumber, UINT8 byAction, UINT32 dwAreaID, UINT32 dwPlayerID, UINT32 dwParam1, UINT64 qwParam2, UINT64 qwParam3, TCHAR* pszParam4, TCHAR* pszParam5, TCHAR *pszDesc)
{
...
string CDealFrame33::GetStrFrameType()
{
    return DEC_COIN;
}

void CDealFrame33::Interface( CRCClient* poClinet )
{
    if (NULL == poClinet)
    {
        return;
    ...
    mapField[DEC_COIN_COUNT_PARAM] = SDGBK2UTF8(DEC_COIN_GBK) + "|" + GM_PARAM_INT;

    RsponeMsg(poClinet, mapField);
}

string CDealFrame33::GetStrFrameDesc()
{
    return SDGBK2UTF8(DEC_COIN_DESC);
}
