// DealFrame28.h: interface for the CDealFrame28 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME28_H_
#define _DEALFRAME28_H_
...
class CDealFrame28 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame28();
	virtual ~CDealFrame28();
	CDealFrame28(InterfaceDealBase::CGmManager * IN_pManager)
	{
