...
#ifndef _DEALFRAMESTUDY_H_
#define _DEALFRAMESTUDY_H_



#include "rsdealframe.h"

class CDealFrameStudy : public InterfaceDealBase::CRsDealFrame  
{
public:
	CDealFrameStudy();
	virtual ~CDealFrameStudy();
	CDealFrameStudy(InterfaceDealBase::CRsManager * IN_pManager)
	{
