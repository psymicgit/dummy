// DealFrame47.h: interface for the CDealFrame47 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME47_H_
#define _DEALFRAME47_H_
...
class CDealFrame47 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame47();
	virtual ~CDealFrame47();
	CDealFrame47(InterfaceDealBase::CGmManager * IN_pManager)
	{
