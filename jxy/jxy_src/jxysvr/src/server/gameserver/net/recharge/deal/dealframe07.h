// DealFrame07.h: interface for the CDealFrame07 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME07_H_
#define _DEALFRAME07_H_
...
class CDealFrame07 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame07();
	virtual ~CDealFrame07();
	CDealFrame07(InterfaceDealBase::CGmManager * IN_pManager)
	{
