// DealFrame63.h: interface for the CDealFrame63 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME63_H_
#define _DEALFRAME63_H_
...
class CDealFrame63 : public InterfaceDealBase::CGmDealFrame  
{
public:
    CDealFrame63();
    virtual ~CDealFrame63();
    CDealFrame63(InterfaceDealBase::CGmManager * IN_pManager)
    {
