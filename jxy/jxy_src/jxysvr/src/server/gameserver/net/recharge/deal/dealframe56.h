// DealFrame56.h: interface for the CDealFrame56 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME56_H_
#define _DEALFRAME56_H_
...
class CDealFrame56 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame56();
	virtual ~CDealFrame56();
	CDealFrame56(InterfaceDealBase::CGmManager * IN_pManager)
	{
