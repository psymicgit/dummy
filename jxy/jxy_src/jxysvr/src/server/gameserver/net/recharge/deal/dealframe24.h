// DealFrame24.h: interface for the CDealFrame24 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME24_H_
#define _DEALFRAME24_H_
...
class CDealFrame24 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame24();
	virtual ~CDealFrame24();
	CDealFrame24(InterfaceDealBase::CGmManager * IN_pManager)
	{
