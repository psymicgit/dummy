// DealFrame01.h: interface for the CDealFrame01 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME01_H_
#define _DEALFRAME01_H_
...
class CDealFrame01 : public InterfaceDealBase::CGmDealFrame
{
public:
    CDealFrame01();
    virtual ~CDealFrame01();
    CDealFrame01(InterfaceDealBase::CGmManager * IN_pManager)
    {
