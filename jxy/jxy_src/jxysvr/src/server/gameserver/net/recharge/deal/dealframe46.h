// DealFrame46.h: interface for the CDealFrame46 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME46_H_
#define _DEALFRAME46_H_
...
class CDealFrame46 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame46();
	virtual ~CDealFrame46();
	CDealFrame46(InterfaceDealBase::CGmManager * IN_pManager)
	{
