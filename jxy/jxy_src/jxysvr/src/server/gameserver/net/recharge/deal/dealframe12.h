// DealFrame12.h: interface for the CDealFrame12 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME12_H_
#define _DEALFRAME12_H_
...
class CDealFrame12 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame12();
	virtual ~CDealFrame12();
	CDealFrame12(InterfaceDealBase::CGmManager * IN_pManager)
	{
