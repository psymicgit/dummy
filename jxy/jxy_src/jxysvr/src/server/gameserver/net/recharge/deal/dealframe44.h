// DealFrame44.h: interface for the CDealFrame44 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME44_H_
#define _DEALFRAME44_H_
...
class CDealFrame44 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame44();
	virtual ~CDealFrame44();
	CDealFrame44(InterfaceDealBase::CGmManager * IN_pManager)
	{
