...
#ifndef _DEALFRAMEBLUEGAS_H_
#define _DEALFRAMEBLUEGAS_H_



#include "rsdealframe.h"

class CDealFrameBluegas : public InterfaceDealBase::CRsDealFrame  
{
public:
	CDealFrameBluegas();
	virtual ~CDealFrameBluegas();
	CDealFrameBluegas(InterfaceDealBase::CRsManager * IN_pManager)
	{
