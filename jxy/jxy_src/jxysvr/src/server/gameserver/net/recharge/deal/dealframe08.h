// DealFrame08.h: interface for the CDealFrame08 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME08_H_
#define _DEALFRAME08_H_
...
class CDealFrame08 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame08();
	virtual ~CDealFrame08();
	CDealFrame08(InterfaceDealBase::CGmManager * IN_pManager)
	{
