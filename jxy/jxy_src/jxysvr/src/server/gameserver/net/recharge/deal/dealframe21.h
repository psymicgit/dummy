// DealFrame21.h: interface for the CDealFrame21 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME21_H_
#define _DEALFRAME21_H_
...
class CDealFrame21 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame21();
	virtual ~CDealFrame21();
	CDealFrame21(InterfaceDealBase::CGmManager * IN_pManager)
	{
