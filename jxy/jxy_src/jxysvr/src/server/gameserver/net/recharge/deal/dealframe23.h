// DealFrame23.h: interface for the CDealFrame23 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME23_H_
#define _DEALFRAME23_H_
...
class CDealFrame23 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame23();
	virtual ~CDealFrame23();
	CDealFrame23(InterfaceDealBase::CGmManager * IN_pManager)
	{
