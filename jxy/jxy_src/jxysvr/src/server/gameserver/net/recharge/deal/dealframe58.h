// DealFrame58.h: interface for the CDealFrame58 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME58_H_
#define _DEALFRAME58_H_
...
class CDealFrame58 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame58();
	virtual ~CDealFrame58();
	CDealFrame58(InterfaceDealBase::CGmManager * IN_pManager)
	{
