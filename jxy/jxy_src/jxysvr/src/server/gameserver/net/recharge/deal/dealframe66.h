...
#ifndef _DEALFRAME66_H_
#define _DEALFRAME66_H_
...
class CDealFrame66 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame66();
	virtual ~CDealFrame66();
	CDealFrame66(InterfaceDealBase::CGmManager * IN_pManager)
	{
