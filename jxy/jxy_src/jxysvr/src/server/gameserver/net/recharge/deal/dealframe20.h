// DealFrame20.h: interface for the CDealFrame20 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME20_H_
#define _DEALFRAME20_H_
...
class CDealFrame20 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame20();
	virtual ~CDealFrame20();
	CDealFrame20(InterfaceDealBase::CGmManager * IN_pManager)
	{
