// DealFrame45.h: interface for the CDealFrame45 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME45_H_
#define _DEALFRAME45_H_
...
class CDealFrame45 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame45();
	virtual ~CDealFrame45();
	CDealFrame45(InterfaceDealBase::CGmManager * IN_pManager)
	{
