...
#ifndef _DEALFRAMESTORY_H_
#define _DEALFRAMESTORY_H_



#include "rsdealframe.h"

class CDealFrameStory : public InterfaceDealBase::CRsDealFrame  
{
public:
	CDealFrameStory();
	virtual ~CDealFrameStory();
	CDealFrameStory(InterfaceDealBase::CRsManager * IN_pManager)
	{
