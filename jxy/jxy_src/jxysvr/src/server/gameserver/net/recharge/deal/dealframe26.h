// DealFrame26.h: interface for the CDealFrame26 class.
//
//////////////////////////////////////////////////////////////////////

#ifndef _DEALFRAME26_H_
#define _DEALFRAME26_H_
...
class CDealFrame26 : public InterfaceDealBase::CGmDealFrame  
{
public:
	CDealFrame26();
	virtual ~CDealFrame26();
	CDealFrame26(InterfaceDealBase::CGmManager * IN_pManager)
	{
