...
#define SECONDES_PER_DAY 86400 //每天的秒数
/**
* @file sdtime.h
...
namespace SGDP
{
    ...
    */
    ...
    public:
        ...
        * @return 差距的天数
        */
        INT64 DiffDay(const CSDDateTime &datetime);//时间24小时差		
		INT32 DiffDateDay(const CSDDateTime &datetime);//日期差
        /**
    ...
    */
	...
	BOOL IsToday(time_t t);//是否今天

	/**
    * @brief 获取当天经过的秒数
    * @return 当天经过的秒数
    */
    UINT32 GetDayPassSecond(time_t t = SDTimeSecs());
