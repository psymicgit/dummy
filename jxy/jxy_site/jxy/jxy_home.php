	...
	<script type="text/javascript">
		var pageCtrl = {
				init :function() {
					...
					frameMessage._init([{"name":"后台管理","allow":true,"children":[{"name":"数据库","allow":true,"children":[{"name":"各区执行sql","link":"jxy_each_zone_exec_sql.php","allow":true},{"name":"查询元宝","link":"jxy_query_gold.php","allow":true}]},{"name":"服务器管理","allow":false,"children":[{"name":"执行shell脚本","link":"jxy_host.php","allow":true}, {"name":"上传服务器","link":"jxy_upload.php","allow":true}]}]}], "/", "",false);
				},
				initLayout :function() {
