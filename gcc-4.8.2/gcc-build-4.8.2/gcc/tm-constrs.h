/* Generated automatically by the program 'build/genpreds'
   from the machine description file '../../gcc-4.8.2/gcc/config/i386/i386.md'.  */
...
satisfies_constraint_w (rtx op)
{
  enum machine_mode mode = GET_MODE (op);
  return (!(
#line 138 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
...
#line 145 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 31)));
}
static inline bool
satisfies_constraint_J (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 150 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 63)));
}
static inline bool
satisfies_constraint_K (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 155 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
...
satisfies_constraint_L (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 161 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
...
satisfies_constraint_M (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 167 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 3)));
}
static inline bool
satisfies_constraint_N (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 173 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 255)));
}
static inline bool
satisfies_constraint_O (rtx op)
{
  ...
  if (CONST_INT_P (op))
    ival = INTVAL (op);
  return (GET_CODE (op) == CONST_INT) && (
#line 178 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
(IN_RANGE (ival, 0, 127)));
}
static inline bool
...
#line 187 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
...
{
  return 
#line 192 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
...
#line 210 "../../gcc-4.8.2/gcc/config/i386/constraints.md"
