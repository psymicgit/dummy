...
class AddObjNotify : public ::google::protobuf::Message {
 public:
  AddObjNotify();
  virtual ~AddObjNotify();

  AddObjNotify(const AddObjNotify& from);

  inline AddObjNotify& operator=(const AddObjNotify& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const AddObjNotify& default_instance();

  void Swap(AddObjNotify* other);

  // implements Message ----------------------------------------------

  AddObjNotify* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const AddObjNotify& from);
  void MergeFrom(const AddObjNotify& from);
  void Clear();
  bool IsInitialized() const;
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static AddObjNotify* default_instance_;
};
// -------------------------------------------------------------------
...
// required int64 obj_id = 1;
inline bool AddObjNotify::has_obj_id() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void AddObjNotify::set_has_obj_id() {
  _has_bits_[0] |= 0x00000001u;
}
inline void AddObjNotify::clear_has_obj_id() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void AddObjNotify::clear_obj_id() {
  obj_id_ = GOOGLE_LONGLONG(0);
  clear_has_obj_id();
}
inline ::google::protobuf::int64 AddObjNotify::obj_id() const {
  return obj_id_;
}
inline void AddObjNotify::set_obj_id(::google::protobuf::int64 value) {
  set_has_obj_id();
  obj_id_ = value;
}

// required float x = 2;
inline bool AddObjNotify::has_x() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void AddObjNotify::set_has_x() {
  _has_bits_[0] |= 0x00000002u;
}
inline void AddObjNotify::clear_has_x() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void AddObjNotify::clear_x() {
  x_ = 0;
  clear_has_x();
}
inline float AddObjNotify::x() const {
  return x_;
}
inline void AddObjNotify::set_x(float value) {
  set_has_x();
  x_ = value;
}

// required float y = 3;
inline bool AddObjNotify::has_y() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void AddObjNotify::set_has_y() {
  _has_bits_[0] |= 0x00000004u;
}
inline void AddObjNotify::clear_has_y() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void AddObjNotify::clear_y() {
  y_ = 0;
  clear_has_y();
}
inline float AddObjNotify::y() const {
  return y_;
}
